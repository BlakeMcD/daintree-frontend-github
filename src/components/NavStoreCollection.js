        ...
        <Header/>
            ...
            <div className ="filterAndContainer">
                <div className="filter">
                    <Filter sendStoreToParent={sendStoreToParent} sendCategoryToParent={sendCategoryToParent} sendGenderToParent={sendGenderToParent} sendSizeToParent={sendSizeToParent} renderStore={false}/>
                </div>
                {renderProducts()}
            </div>
            <div className="spacer"/>
